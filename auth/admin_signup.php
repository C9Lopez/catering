...
$attempts_key = "admin_signup_attempts_$ip";
$lockout_key = "admin_signup_lockout_$ip";
$max_attempts = 5;
$lockout_time = 15 * 60; // 15 minutes in seconds

// Check if the user is already signed up and redirect to login
            ...
            if (empty($password)) {
                ...
                try {
                    ...
                    if ($stmt->rowCount() > 0) {
                        ...
                        $_SESSION['signup_success'] = true; // Set a flag to indicate successful signup
                        $_SESSION['flash_message'] = "Admin account created successfully! Please log in."; // Set flash message
                    }
...
<html lang="en">
<head>
    <title>Admin Signup - Pochie Catering</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="../css/admin.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <!-- Load jQuery and Bootstrap JS in the head to ensure they are available -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>
    <style>
        .signup-container { display: flex; justify-content: center; align-items: center; min-height: 100vh; }
        .signup-card { max-width: 500px; width: 100%; padding: 2rem; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); border-radius: 12px; background: white; }
        .signup-logo { max-width: 100px; }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="successModalLabel">Admin Account Created!</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center">
                    🎉 Admin account has been successfully created!<br>
                    Redirecting to login in 3 seconds...
                </div>
                <div class="modal-footer">
                    <a href="admin_login.php" class="btn btn-success">Go to Login</a>
                </div>
            </div>
        </div>
    </div>
    <script>
        // Ensure the modal and redirect work after the DOM is fully loaded
        document.addEventListener('DOMContentLoaded', function() {
            console.log("DOM fully loaded, showing modal...");
            $("#successModal").modal('show');
            console.log("Modal should be visible now. Starting redirect timer...");
            setTimeout(function() {
                console.log("Redirecting to admin_login.php...");
...
<script>
    // Password visibility and validation script
    document.addEventListener('DOMContentLoaded', function() {
