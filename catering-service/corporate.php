...
// 3. Fetch the package_id for Custom Corporate Package
$custom_package_id = null;
foreach ($corporate_packages as $pkg) {
...
// 4. Fetch active corporate menu items for custom package
try {
    $menus_stmt = $db->prepare("SELECT m.*, c.category_name FROM menus m LEFT JOIN menu_categories c ON m.category_id = c.category_id WHERE m.service_type = 'corporate' AND m.status = 'active' ORDER BY c.category_name, m.title");
    $menus_stmt->execute();
    $corporate_menus = $menus_stmt->fetchAll(PDO::FETCH_ASSOC);
    
    // Fix image paths
    foreach ($corporate_menus as &$menu) {
    ...
    unset($menu); 
    $corporate_menus_json = json_encode($corporate_menus);
} catch (PDOException $e) {
    error_log("Error fetching corporate menus: " . $e->getMessage());
    $corporate_menus = [];
    $corporate_menus_json = json_encode([]);
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        /* --- COPYING STYLES (With Corporate Colors) --- */
        ...
        /* CORPORATE THEME COLOR (Blue/Cyan Gradient) */
        .package-header {
...
<?php include '../layout/navbar.php'; ?>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="mb-4">
                        ...
                        conference, product launch, or company celebration, we deliver exceptional food and service.
                    </p>
                    <div class="row g-4">
                        ...
                        <div class="col-md-6"><div class="d-flex align-items-center mb-3"><i class="fas fa-check text-primary me-3"></i><span>Flexible Menus</span></div></div>
                        <div class="col-md-6"><div class="d-flex align-items-center mb-3"><i class="fas fa-check text-primary me-3"></i><span>On-Time Delivery</span></div></div>
                        <div class="col-md-6"><div class="d-flex align-items-center mb-3"><i class="fas fa-check text-primary me-3"></i><span>Corporate Presentation</span></div></div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="container">
            <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.3s">
                <h1 class="display-4 text-title fw-bold">Corporate Packages</h1>
    ...
    <div class="container-fluid py-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="fs-5 text-muted">Build your own corporate package by selecting from our menu items below.</p>
            </div>
            <form id="customCorporateForm">
                <div class="row">
                    <div class="col-lg-8">
    ...
    <script>
        ...
        const corporateMenus = <?php echo $corporate_menus_json; ?>;
        ...
        $('#customBookNowBtn').on('click', function() {
            ...
            bookNowButton.setAttribute('data-package-name', "Custom Corporate Package");
