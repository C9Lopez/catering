...
try {
    $stmt = $db->prepare("SELECT * FROM menus WHERE service_type = 'private' ORDER BY category");
    $stmt->execute();
...
<head>
    <meta charset="UTF-8">
    <title>Private Party Menu - Pochie Catering</title>
...
<body class="light-theme">
    ...
    <div class="container-fluid hero-section py-6 my-6 text-center wow fadeInUp" data-wow-delay="0.3s">
        ...
        <div class="container position-relative text-white">
            <h1 class="display-1 mb-4">Private Party <span class="text-primary">Menu</span></h1>
            <p class="lead">Explore our exquisite menu options for your wedding event.</p>
            <a href="./private.php" class="btn btn-primary border-0 rounded-pill py-2 px-3 px-md-3 animated bounceInLeft">Back to Private Party Booking</a>
        </div>
    </div>
    <!-- Hero End -->
