...
// Fetch Children's Party packages
try {
...
<?php include '../layout/navbar.php'; ?>
    ...
    <!-- Children's Party Packages Section -->
    <div class="container-fluid py-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="container">
            <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <p class="fs-5 text-subtitle">Choose the perfect package for your Children's Party</p>
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="bookingModalLabel">Book Your Children's Party Catering</h5>
    ...
    <script>
        ...
        // Client-side Pagination for Children's Party Packages
