...
try {
    ...
    if (empty($bookings)) {
        echo "<tr><td colspan='9' class='text-center text-muted'>No approved bookings found.</td></tr>";
    } else {
    ...
    echo "<tr><td colspan='9' class='text-center text-muted'>Error loading bookings.</td></tr>";
}
