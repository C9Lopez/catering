...
<head>
    <meta charset="UTF-8">
    <title>Standard Packages - Pochie Catering</title>
...
<?php include '../layout/navbar.php'; ?>
    ...
    <div class="container-fluid hero-section py-6 my-6 text-center wow fadeInUp" data-wow-delay="0.3s">
        ...
        <div class="container position-relative text-white">
            <h1 class="display-1 mb-4">Standard <span class="text-primary">Packages</span></h1>
            <p class="lead">Quality catering solutions that offer great value for your events and celebrations.</p>
            <a href="../book.php" class="btn btn-primary py-3 px-5 rounded-pill wow bounceInLeft" data-wow-delay="0.5s">Book Now</a>
        </div>
    </div>
    <!-- Hero End -->

    <!-- About Standard Packages -->
    <div class="container-fluid py-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-5 mb-4">Standard Package Excellence</h1>
                    <p class="mb-4">
                        Our standard packages are designed to provide excellent catering services at competitive prices. 
                        Perfect for various occasions, these packages offer a balanced combination of quality food, 
                        professional service, and essential amenities to make your event successful.
                    </p>
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3">
                                <i class="fas fa-check text-primary me-3"></i>
                                <span>Quality Menu Selection</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3">
                ...
                <div class="col-lg-6 wow zoomIn" data-wow-delay="0.5s">
                    <img src="../img/event-4.jpg" class="img-fluid rounded" alt="Standard Package">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="container">
            <div class="text-center mb-5">
                <h1 class="display-5">Our Standard Packages</h1>
                <p class="fs-5">Choose the perfect standard package for your event</p>
            </div>
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="0.1s">
                    <div class="package-item rounded overflow-hidden">
                        <div class="text-center p-4">
                            <h3 class="mb-0">Basic Standard</h3>
                            <div class="mb-3">
                            ...
                            <h1 class="mb-3">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">₱</small>30,000<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ package</small>
                            </h1>
                        </div>
                        <div class="p-4">
                            ...
                            <p><i class="fa fa-check text-primary me-2"></i>Basic Setup</p>
                ...
                <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="0.5s">
                    <div class="package-item rounded overflow-hidden">
                        <div class="text-center p-4">
                            ...
                            <h1 class="mb-3">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;">₱</small>60,000<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ package</small>
                            </h1>
                        </div>
                        <div class="p-4">
                            <p><i class="fa fa-check text-primary me-2"></i>Up to 150 Guests</p>
                            <p><i class="fa fa-check text-primary me-2"></i>8 Main Courses</p>
                            <p><i class="fa fa-check text-primary me-2"></i>4 Desserts</p>
                            <p><i class="fa fa-check text-primary me-2"></i>Premium Setup</p>
            ...
            <div class="row g-4">
                    ...
                    <div class="gallery-item">
                        ...
                        <div class="gallery-content">
                            <div class="gallery-info">
                                <h5 class="text-white text-uppercase mb-2">Event Setup</h5>
                ...
                <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="0.3s">
                    <div class="gallery-item">
                        ...
                        <div class="gallery-content">
                            <div class="gallery-info">
                                <h5 class="text-white text-uppercase mb-2">Food Presentation</h5>
