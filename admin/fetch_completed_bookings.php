...
$whereClause = "WHERE eb.booking_status = 'completed'";
$params = [];
...
try {
    ...
    if (empty($bookings)) {
        echo "<tr><td colspan='10' class='text-center text-muted'>No completed bookings found.</td></tr>";
    } else {
        foreach ($bookings as $row) {
            ...
            if ($isCustom) {
                ...
                if (!empty($customizations)) {
                    ...
                    $customDetails .= "<div class='text-muted'>No custom menu items found.</div>";
                }
